 ...
 *
 */
public class WenwoMongoTemplate extends MongoTemplate implements Cloneable {
	 ...
	 */
	public WenwoMongoTemplate(Mongo mongo, String databaseName) {
	 ...
	 */
	public WenwoMongoTemplate(Mongo mongo, String databaseName, UserCredentials userCredentials) {
	 ...
	 */
	public WenwoMongoTemplate(MongoDbFactory mongoDbFactory) {
	 ...
	 */
	public WenwoMongoTemplate(MongoDbFactory mongoDbFactory, MongoConverter mongoConverter) {
